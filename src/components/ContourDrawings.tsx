...
const EXIT_TRANSITION = { duration: 0.18, ease: "easeOut" } as const;
        ...
        >
          ...
          >
            <AnimatePresence mode="wait">
              <motion.svg key={replay[0]} viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="absolute inset-0 text-[#c9b8dc] w-full h-full" initial="hidden" whileInView="visible" viewport={{ once: true }} exit={{ opacity: 0, transition: EXIT_TRANSITION }}>
          ...
          >
            <AnimatePresence mode="wait">
              <motion.svg key={replay[1]} viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="absolute inset-0 text-[#c9b8dc] w-full h-full" initial="hidden" whileInView="visible" viewport={{ once: true }} exit={{ opacity: 0, transition: EXIT_TRANSITION }}>
          ...
          <motion.div
            ...
            transition={HOVER_TRANSITION}
            onMouseEnter={() => bump(2)}
            title="Movimento Positivo"
          >
            <AnimatePresence mode="wait">
              <motion.svg key={replay[2]} viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="absolute inset-0 text-[#c9b8dc] w-full h-full" initial="hidden" whileInView="visible" viewport={{ once: true }} exit={{ opacity: 0, transition: EXIT_TRANSITION }}>
